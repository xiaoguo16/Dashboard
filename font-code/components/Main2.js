...
module.exports= class Main extends Component {
    ...
    handleClick13 () {
       // window.location.href="http://dashboard.client.weibo.cn/performance/app_launch";
        window.location.href='http://localhost:8082/app_launch';
        /*
        this.setState({
            current: '13',
            style11:'navDetail11',
        ...
        return (
            <div style={styles.root}>
                <div style={styles.head}>
                    <div style={styles.navFont}><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;视频性能分析Dashboard</span></div>
                    <section className="tabs">
                        <input id="tab-1" type="radio" name="radio-set" className="tab-selector-1" checked="checked" />
                        <label htmlFor="tab-1" className="tab-label-1" >多媒体</label>
