...
export default class PandectChoose extends Component {
    ...
    render() {
        ...
        const true1=true
        let all;
        if(ListStore.data.pansect.flag){
            all=(
                        ...
                        <div style={styles.choose}>
                            ...
                            <Row >
                                <Col xs={5} md={5} lg={5} style={{padding:'10px 0px',paddingLeft:'20px',}}>
                                    <span>手机系统：</span>
                                    <Select  style={{ width: '40%' }} size="large" onChange={this.changeSystem} value={ListStore.data.pansect.PortData.phonetype}>
                                        {computerType_select}
                                    </Select>
                                </Col>
                                ...
                                <Col  xs={5} md={5} lg={5} style={{padding:'10px 0px',paddingLeft:'20px',}}>
                                    <span>微博版本：</span>
                                    <Select  style={{ width: '40%',}} size="large" onChange={this.changeWbVersion} value={ListStore.data.pansect.PortData.app_version}>
                                        {version_select}
                                    </Select>
                                </Col>
                                ...
                                <Col  xs={5} md={5} lg={5} style={{padding:'10px 0px',paddingLeft:'20px',}}>
                                    <span>网络类型：</span>
                                    <Select    style={{ width: '40%', }} size="large" onChange={this.changeNetType} value={ListStore.data.pansect.PortData.network_type}>
                                        {netType_select}
                                    </Select>
                                </Col>
                            ...
                            <Row>
                                ...
                                <Col xs={5} md={5} lg={5}  style={{padding:'10px 0px',paddingLeft:'20px',}}>
                                    <span>时间粒度：</span>
                                    <Select style={{ width: '40%' }} size="large" onChange={this.changeLd} value={ListStore.data.pansect.PortData.granularity}>
                                ...
                                <Col xs={10} md={8} lg={8}  style={{padding:'10px 0px',paddingLeft:'20px',}}>
                                    ...
                                    <RangePicker style={{width: '72%' }} defaultValue={[moment(this.getRecent7Days()[1], dateFormat), moment(this.getRecent7Days()[0], dateFormat)]}
                                                 ...
                                                 value={[moment(ListStore.data.pansect.PortData.startdate, dateFormat), moment(ListStore.data.pansect.PortData.enddate, dateFormat)]}/>
                                </Col>
                                <Col xs={0} md={0} lg={1}  style={styles.col}>
                                </Col>
                            </Row>
